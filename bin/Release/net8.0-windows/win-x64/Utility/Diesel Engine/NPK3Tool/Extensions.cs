...
namespace NPK3Tool
{
    static class Extensions
    {
        ...
        class AesCryptoStream : CryptoStream
        {
            private Aes _aes;
            public AesCryptoStream(Stream stream, ICryptoTransform transform, CryptoStreamMode mode, Aes aes)
        ...
        public static Stream CreateDecryptor(this Stream Stream, byte[] Key, byte[] IV)
        {
            ...
            return new AesCryptoStream(Stream, decryptor, CryptoStreamMode.Read, aes);
        }
        ...
        public static Stream CreateEncryptor(this Stream Stream, byte[] Key, byte[] IV)
        {
            ...
            return new AesCryptoStream(Stream, encryptor, CryptoStreamMode.Read, aes);
        }
